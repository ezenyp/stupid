...
namespace EventNow
{
    public partial class ViewEvents : System.Web.UI.Page
    {
        ...
        protected void community_Click(object sender, EventArgs e)
        {
            ...
            EventList.SelectCommand = "SELECT * FROM Event WHERE EventType LIKE '%" + SearchName + "%' AND EventLink LIKE 'Internal'";
            EventList.DataBind();
        }
        ...
        {
            EventList.SelectCommand = "SELECT * FROM Event WHERE EventLink LIKE 'Internal'";
            EventList.DataBind();
        }
