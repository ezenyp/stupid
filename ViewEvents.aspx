<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" CodeBehind="ViewEvents.aspx.cs" Inherits="EventNow.ViewEvents" %>
        ...
        <div class="pt-5">
            <div class="container">
                <div class="col-md-12 text-center pt-5 mt-4">
                    ...
                    <asp:Button ID="entrepreneurship" CssClass="btn btn-outline-dark btn-sg me-4" runat="server" Text="Entrepreneurship" OnClick="entrepreneurship_Click" />
            ...
            <div class="container">
                <div class="pt-3 mt-3">
                    <div class="row">
                        ...
                        <asp:SqlDataSource ID="EventList" runat="server" ConnectionString="<%$ ConnectionStrings:EventNowDB.mdf %>" SelectCommand="SELECT * FROM [Event] WHERE EventLink LIKE 'Internal'"></asp:SqlDataSource>
