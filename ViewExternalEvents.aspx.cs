...
namespace EventNow
{
    public partial class ViewExternalEvents : System.Web.UI.Page
    {
        Event ent = new Event();
        ...
        protected void community_Click(object sender, EventArgs e)
        {
            ...
            EventList.SelectCommand = "SELECT * FROM Event WHERE EventType LIKE '%" + SearchName + "%' AND EventLink LIKE 'External'";
            EventList.DataBind();
        }
        ...
        {
            EventList.SelectCommand = "SELECT * FROM Event WHERE EventLink LIKE 'External'";
            EventList.DataBind();
        }
        ...
        protected void RepeaterList1_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            //    if (result > 0)
            //    {
            //        Response.Redirect("ViewExternalEvents.aspx");
